...
wd = os.getcwd()
input_path = os.path.join(wd, r'C:\Users\User\Desktop\GaitSet-master\GaitDatasetA-silh\pretreatment')
output_path = os.path.join(wd,r'C:\Users\User\Desktop\GaitSet-master\GaitDatasetA-silh\output')
