...
wd = os.getcwd()
input_path = os.path.join(wd, r'C:\Users\User\Desktop\wyx-GaitSet-master\output1\output_synthesis')
output_path = os.path.join(wd, r'C:\Users\User\Desktop\wyx-GaitSet-master\output1\output_synthesis_rotate')
